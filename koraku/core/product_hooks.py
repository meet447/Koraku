...
def configure_automation_scheduler(agent: Any | None) -> None:
    if _registered is not None and _registered.configure_automation_scheduler is not None:
        _registered.configure_automation_scheduler(agent)
        return
...
def start_automation_scheduler() -> None:
    if _registered is not None and _registered.start_automation_scheduler is not None:
        _registered.start_automation_scheduler()
        return
    from koraku.automations import scheduler as automation_scheduler
...
def shutdown_automation_scheduler() -> None:
    if _registered is not None and _registered.shutdown_automation_scheduler is not None:
        _registered.shutdown_automation_scheduler()
        return
    from koraku.automations import scheduler as automation_scheduler
